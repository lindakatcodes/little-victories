export const taskList = [
  ...
  {
    task: "Practice intro for 5 minutes",
  ...
  },
  {
    ...
    tip: "Time to find a role you're interested in! Track down one job posting that sounds interesting to you.",
    hasPrereq: false,
  },
  {
  ...
  },
  {
    ...
    tip: "Great for networking and skill building! Find an event from a meetup group (local if possible) or a video/podcast for a skill you'd like to learn or improve. Attend or watch the recording, and make note of the things you learn or the people you met.",
    hasPrereq: false,
  },
  {
    task: "Code test practice",
  ...
  {
    task: "Code project practice",
    tip: "Do you have a side project you're working on? Or some small tool you wish would exist that you could build? Spend one hour working on your project, whatever it is. If you don't have the time or ability for a full project, review some PRs for open source projects you like, or voice dictate some pseudo code on your commute for an idea, or use an LLM agent to help you create something. Anything to keep your working skills sharp within a project context.",
    hasPrereq: false,
  },
  {
    task: "LinkedIn post: skill share",
    tip: "Share something you learned from the event/video you saw or the code problems you solved. Showcase that you're actively working on keeping your skills sharp, learning new ones, and staying active within your community however you can. What interested you from the things you did this cycle?",
    hasPrereq: false,
  },
  {
